...
public class Padding
{
    ...
    private readonly int[] paddingValues = new int[5];
    ...
    {
        return paddingValues[(int)side];
    }


    public int GetSide(int index)
    {
        return index <= paddingValues.Length
            ? paddingValues[index]
    ...
    {
        for (var i = 0; i < paddingValues.Length; i++) paddingValues[i] = amount;
    }
    ...
    {
        return paddingValues[(int)side] + additionalPadding > 0
    ...
    {
        return paddingValues[paddingIndex] + additionalPadding > 0
