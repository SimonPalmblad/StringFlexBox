...
{
    private readonly char[] borderChars = new char[4];
    private readonly char[] cornerChars = new char[4];
    ...
    /// </summary>
    public static FlexBoxBorder Default => new(new[] { '│', '│', '─', '─' }, new[] { '┌', '┐', '└', '┘' });

    /// <summary>
    ///     Hides the border characters but still draws empty characters in place of the border.
    /// </summary>
    public static FlexBoxBorder Invisible => new(new[] { ' ', ' ', ' ', ' ' }, new[] { ' ', ' ', ' ', ' ' });

    /// <summary>
    ///     Removes the border entirely.
    /// </summary>
    public static FlexBoxBorder None => new(new[] { '\0', '\0', '\0', '\0' }, new[] { '\0', '\0', '\0', '\0' });
    ...
    public void SetLeftBorder(char character)
    {
        borderChars[0] = character;
    }

    public void SetRightBorder(char character)
    {
        borderChars[1] = character;
    }

    public void SetTopBorder(char character)
    {
        borderChars[2] = character;
    }

    public void SetBottomBorder(char character)
    {
        borderChars[3] = character;
    }
    ...
    public void SetTopLeftCorner(char character)
    {
        cornerChars[0] = character;
    }

    public void SetTopRightCorner(char character)
    {
        cornerChars[1] = character;
    }

    public void SetBottomLeftCorner(char character)
    {
        cornerChars[2] = character;
    }

    public void SetBottomRightCorner(char character)
    {
        cornerChars[3] = character;
    }
